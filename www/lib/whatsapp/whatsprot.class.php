...
class WhatsProt
{
     ...
     */
    public function __construct($nickname = "RPi", $number = "34668892190", $identity = 0, $debug = FALSE)
    {
        $dict = getDictionary();
    ...
    public function LoginWithPassword($password = "G9o8Y9NxTnvl+3ylxfg+B4YdCqg=")
    {
